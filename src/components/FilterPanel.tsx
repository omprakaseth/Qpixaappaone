...
const categoryOptions = ['All', 'Portrait', 'Anime', 'Cars', 'Nature', 'Cyberpunk', 'Fantasy', 'Space', 'Characters', 'Landscape'];

export default function FilterPanel({ open, onClose, onApply }: FilterPanelProps) {
  const [filters, setFilters] = useState<FilterState>({
    style: 'All', popularity: 'All', time: 'All Time', category: 'All'
  });
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/60" onClick={onClose}>
      <div
        className="absolute bottom-0 left-0 right-0 bg-card rounded-t-2xl p-5 max-h-[85vh] overflow-y-auto"
      ...
      >
        ...
        <FilterSection label="Category" options={categoryOptions} value={filters.category} field="category" />
        ...
        <div className="flex gap-3 mt-4">
          <button
            onClick={() => setFilters({ style: 'All', popularity: 'All', time: 'All Time', category: 'All' })}
